...
from py3_14_features import Foo
from py3_14_features import get_foo_len
from py3_14_features import get_foo_len_clone
from py3_14_features import get_len
from py3_14_features import get_len_clone
...
def test_signature():
    ...
    assert inspect.signature(get_len, annotation_format=inspect.Format.STRING) == inspect.signature(
        get_len_clone, annotation_format=inspect.Format.STRING
    )
