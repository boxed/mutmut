...
from mutate_only_covered_lines import function_with_pragma
from mutate_only_covered_lines import hello_mutate_only_covered_lines
from mutate_only_covered_lines import mutate_only_covered_lines_multiline
...
def test_mutate_only_covered_lines_multiline():
    assert (
        ...
        == "Hello from mutate_only_covered_lines! (true) FooBar [0, 4, 8, 12, 16]"
    )
