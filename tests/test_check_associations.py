...
class TestCheckTestToMutantAssociations:
    ...
    def test_no_expected_keys_is_noop(self):
        ...
        state().tests_by_mangled_function_name["whatever.x_add"].add("tests/test_foo.py::test_add")
    ...
    def test_disjoint_keys_exits_with_diagnostic(self, capsys):
        ...
        state().tests_by_mangled_function_name["foo.x_add"].add("tests/test_foo.py::test_add")
        state().tests_by_mangled_function_name["foo.x_is_positive"].add("tests/test_foo.py::test_is_positive")
